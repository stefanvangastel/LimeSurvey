...
<script type='text/javascript'>
    ...
    function start_popup_editor(fieldname, fieldtext, sid, gid, qid, fieldtype, action)
    {
        ...
        if (activepopup == null)
        {
            ...
            popup = window.open('<?php echo $this->createUrl('admin/htmleditor_pop/sa/index'); ?>/name/'+fieldname+'/text/'+fieldtext+'/type/'+fieldtype+'/action/'+action+'/sid/'+sid+'/gid/'+gid+'/qid/'+qid+'/lang/<?php echo Yii::app()->getLanguage(); ?>','', 'location=no, status=yes, scrollbars=auto, menubar=no, resizable=yes, width=690, height=500');
